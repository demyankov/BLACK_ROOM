let app = document.querySelector(".banner__wrapper");
...
function visible(target) {
  ...
  targetPosition.bottom > windowsPosition.top
...
var camera = {
  ...
  zoom: 1,
  display: { x: app.clientWidth / 2, y: app.clientHeight / 3.7, z: 0 },
};
...
var fullSet = function () {
  var alpha =
    "ABCDEFGHIJKLMNOPQRSTUVWXYZАБВГДЕЁЖЗИЙКЛМНОПРСТУФХЦЧШЩЪЫЬЭЮЯ__?!1234567890";
  var col = 10;
  var colUnit = 80;
  var rowUnit = 120;
